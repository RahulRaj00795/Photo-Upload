...
mongoose.connect(process.env.MONGODB_URI, { useNewUrlParser: true, useUnifiedTopology: true }) // Access MongoDB URI from environment variables
  .then(() => {
...
const PORT = process.env.PORT || 4000; // Access the port from environment variables or use default 4000
